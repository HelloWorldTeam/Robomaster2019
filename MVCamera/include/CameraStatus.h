...
#define CAMERA_STATUS_USER_CANCEL \
  -9  // 用户手动取消了，比如roi面板点击取消，返回
...
#define CAMERA_STATUS_SENSOR_ID_DISMATCH \
  -42  // 固件和程序不匹配，原因是下载了错误的固件。
...
#define CAMERA_AIA_NO_REF_TIME \
  0x0813  //没有参考时钟源。多用于时间同步的命令执行时
